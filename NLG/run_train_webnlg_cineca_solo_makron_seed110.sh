#!/bin/bash
#SBATCH -J runNLG_webnlg_solo_makron_seed110
#SBATCH -o runNLG_webnlg_solo_makron_seed110.%J.txt
#SBATCH -e runNLG_webnlg_solo_makron_seed110.%J.txt
#SBATCH --nodes=1                    # 1 node
#SBATCH --ntasks-per-node=4         # 32 tasks per node
#SBATCH --time=23:30:00               # time limits: 1 hour
